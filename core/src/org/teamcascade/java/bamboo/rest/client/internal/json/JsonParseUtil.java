...
package org.teamcascade.java.bamboo.rest.client.internal.json;
...
import org.teamcascade.java.bamboo.rest.client.api.ExpandableProperty;
import org.teamcascade.java.bamboo.rest.client.api.OptionalIterable;
import org.teamcascade.java.bamboo.rest.client.api.RestClientException;
import org.teamcascade.java.bamboo.rest.client.api.domain.BasicUser;
...
public class JsonParseUtil {
	public static final String BAMBOO_DATE_TIME_PATTERN = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
	public static final DateTimeFormatter BAMBOO_DATE_TIME_FORMATTER = DateTimeFormat.forPattern(BAMBOO_DATE_TIME_PATTERN);
	public static final DateTimeFormatter BAMBOO_DATE_FORMATTER = ISODateTimeFormat.date();
	...
	public static String formatDate(final DateTime dateTime) {
		return BAMBOO_DATE_FORMATTER.print(dateTime);
	}
