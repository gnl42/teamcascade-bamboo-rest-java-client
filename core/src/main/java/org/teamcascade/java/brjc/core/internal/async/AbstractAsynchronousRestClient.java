...
import org.teamcascade.java.bamboo.rest.client.api.domain.ErrorCollection;
import org.teamcascade.java.brjc.core.internal.json.JsonArrayParser;
import org.teamcascade.java.brjc.core.internal.json.JsonObjectParser;
import org.teamcascade.java.brjc.core.internal.json.JsonParseUtil;
import org.teamcascade.java.brjc.core.internal.json.JsonParser;
import org.teamcascade.java.brjc.core.internal.json.gen.JsonGenerator;
...
public abstract class AbstractAsynchronousRestClient {
	...
	protected final <T> Promise<T> getAndParse(final URI uri, final JsonParser<?, T> parser) {
		return callAndParse(client.newRequest(uri)
				.setAccept(JSON_CONTENT_TYPE)
				.get(), parser);
	}
